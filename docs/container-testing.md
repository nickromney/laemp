...
sudo ./laemp.sh -c -w nginx -d mariadb -m 502 -S
```
...
1. `php 8.4 + nginx + mariadb + moodle 502 + self-signed`
2. `php 8.4 + apache + mariadb + moodle 502 + self-signed`
3. `php 8.4 + nginx + pgsql + moodle 502 + self-signed`
